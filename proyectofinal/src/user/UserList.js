...
const UserList = () => {
    ...
    const fetchUsers = async () => {
        try {
            const response = await axios.get('https://paginas-web-cr.com/ucr/multimedios0224/Proyecto_Avenger/Proyecto-grupal/API/users.php');
    ...
    const handleUserSave = async () => {
        try {
            if (isEdit) {
                await axios.put('https://paginas-web-cr.com/ucr/multimedios0224/Proyecto_Avenger/Proyecto-grupal/API/users.php', userEdit);
                Swal.fire({
                    icon: 'success',
                    title: 'Actualizado',
                ...
                await axios.post('https://paginas-web-cr.com/ucr/multimedios0224/Proyecto_Avenger/Proyecto-grupal/API/users.php', userEdit);
                Swal.fire({
                    icon: 'success',
                    title: 'Creado',
    ...
    const handleUserDelete = async () => {
        try {
            await axios.delete('https://paginas-web-cr.com/ucr/multimedios0224/Proyecto_Avenger/Proyecto-grupal/API/users.php', {
    ...
    return (
        <div className="container-xxl">
            <br /><br /><br />
            <Button color="dark" onClick={() => openEditModal(null)}>Agregar Usuario</Button>

            <table className="table table-striped table-hover table-borderless table table-dark align-middle">
