...
const AlbumList = () => {
    ...
    return (
        <div className="container">
            ...
            <Button color="danger" onClick={() => openEditModal(null)}>Agregar Álbum</Button>
                ...
                <ModalBody>
                    <Form>
                        ...
                        <FormGroup>
                            ...
                            <Input type="text" name="gender" id="gender" value={albumEdit?.gender || ''} onChange={handleInputChange} />
                        </FormGroup>
                    </Form>
                </ModalBody>
                <ModalFooter>
