...
<<<<<<< HEAD
    $query = "INSERT INTO Avenger_song (idAlbum, title, duration, demo_path, full_path, price) VALUES (:idAlbum, :title, :duration, :demo_path, :full_path, :precio)";
    $stmt = $db->prepare($query);
    $stmt->bindParam(":idAlbum", $data->album_id);
=======
